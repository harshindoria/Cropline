...
export default function FarmerProfilePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      // The update profile schema accepts strings for most, numbers for lat/lng and farmArea
      ...
      if (payload.farmArea) payload.farmArea = Number(payload.farmArea);
      ...
      if (payload.farmArea === "" || isNaN(payload.farmArea)) delete payload.farmArea;
      ...
      <header className="bg-white border-b border-gray-100 p-4 sticky top-0 z-30 shadow-xs">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#1B5E20]">Farmer Profile</h1>
              <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">Manage your farm and addresses</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col items-center text-center">
              ...
              <h2 className="text-lg font-black text-[#212121]">{user.name || "Farmer"}</h2>
            ...
            <form onSubmit={handleSave} className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="p-6 md:p-8 border-b border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-bold text-gray-500 uppercase tracking-wider">Farm Area (Acres)</label>
                    <input 
                      type="number"
                      step="0.01"
                      name="farmArea"
